...
// GetCatalogBackupRetentionPolicy returns one backup retention policy (catalog) — distinct from admin Backups and alert policies.
func (s *Store) GetCatalogBackupRetentionPolicy(ctx context.Context, kind string) (*BackupRetention, error) {
...
// ListCatalogBackupRetentionPolicies returns every backup retention policy (catalog).
func (s *Store) ListCatalogBackupRetentionPolicies(ctx context.Context) ([]BackupRetention, error) {
...
// SetCatalogBackupRetentionPolicy upserts a backup retention policy for a kind (catalog).
func (s *Store) SetCatalogBackupRetentionPolicy(ctx context.Context, kind string, retentionDays, retentionMax int, enabled bool) (BackupRetention, error) {
	...
	r, err := s.GetCatalogBackupRetentionPolicy(ctx, kind)
	if err != nil {
		return BackupRetention{}, err
	}
	return *r, nil

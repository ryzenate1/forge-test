-- Durable event outbox. This replaces the former untracked programmatic setup
-- in internal/eventstore/migration.go so every Forge schema object is ledgered.

    ...
    <div className="h-screen overflow-hidden bg-[#0a0e14]">
      ...
      <div className="flex h-[calc(100vh-56px)]">
        ...
        <aside className="max-[899px]:hidden w-72 shrink-0 flex-col border-r border-white/[0.06] bg-[#11161f] flex">
          <div className="border-b border-white/[0.06] p-3"><div className="relative"><Search size={14} className="absolute left-3 top-2.5 text-slate-600"/><input aria-label="Search admin navigation" value={navSearch} onChange={(event) => setNavSearch(event.target.value)} placeholder="Find a control…" className="h-9 w-full rounded-lg border border-white/[0.08] bg-black/20 pl-9 pr-3 text-xs text-slate-200 outline-none focus:border-red-400/60"/></div></div>

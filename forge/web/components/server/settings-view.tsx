...
const field = "mt-2 w-full rounded-lg border border-white/10 bg-[var(--surface)] px-3 text-sm text-white outline-none focus:border-red-500 disabled:opacity-60";
